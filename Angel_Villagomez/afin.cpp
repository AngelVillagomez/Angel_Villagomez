...
{
	string alphaL = "abcdefghijklmnopqrstuvwxyz,.-_ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789()";
	// mod n
...
int revisar(string mensaje_original, int a, int b)
{
